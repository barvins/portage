...
inherit cuda eutils flag-o-matic fortran-2 multilib toolchain-funcs versionator python-any-r1 cmake-utils
...
src_configure() { 
   ...
   local mycmakeargs=( 
      -DGPU_TARGET="Pascal"
      -DLAPACK_LIBRARIES="/usr/lib/libreflapack.so;/usr/lib64/libopenblas_openmp.so"
      -DFPIC=-fPIC
   ) 
