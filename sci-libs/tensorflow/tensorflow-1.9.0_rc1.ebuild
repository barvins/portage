...
bazel_external_uris="http://ftp.exim.org/pub/pcre/pcre-8.39.tar.gz
...
src_configure() {
	...
	do_configure() {
		...
		#export GCC_HOST_COMPILER_PATH=/usr/bin/x86_64-pc-linux-gnu-gcc
